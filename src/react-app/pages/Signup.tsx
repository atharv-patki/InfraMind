...
import { Activity, Server, Bell, Brain, Check } from "lucide-react";
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16">
          ...
          <p className="text-lg text-slate-400 mb-12 max-w-md">
            Join thousands of teams using AI-powered monitoring to keep their systems running smoothly.
          </p>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4 text-slate-300">
              ...
              <span>Monitor up to 5 servers free</span>
            </div>
            <div className="flex items-center gap-4 text-slate-300">
              <div className="w-10 h-10 rounded-lg bg-primary/20 flex items-center justify-center">
                <Bell className="w-5 h-5 text-primary" />
              </div>
              <span>Instant alerts via email</span>
            </div>
            <div className="flex items-center gap-4 text-slate-300">
              <div className="w-10 h-10 rounded-lg bg-primary/20 flex items-center justify-center">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-center gap-3">
                ...
                <span>14-day Pro trial with all features</span>
              </li>
              <li className="flex items-center gap-3">
                <Check className="w-4 h-4 text-success shrink-0" />
